                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="d-grid gap-2">
                                    <asp:Button class="btn btn-block btn-success btn-lg" ID="Button1" runat="server" Text="Login" />
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <hr />
                                ...
                                <div class="d-grid gap-2">
                                    ...
                                    <input class="btn btn-block btn-info btn-lg" id="Button2" type="button" value="Sign Up"/>
                                        </a> 
                                </div>
